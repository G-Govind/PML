...
```r
train<-read.csv("C:/Users/govin/OneDrive/Documents/pml-training.csv",na.strings=c("NA","#DIV/0!",""))
test<-read.csv("C:/Users/govin/OneDrive/Documents/pml-testing.csv",na.strings=c("NA","#DIV/0!",""))
```
